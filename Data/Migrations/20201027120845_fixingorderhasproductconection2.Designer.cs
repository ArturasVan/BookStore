...
namespace BookStore.Data.Migrations
{
    ...
    [Migration("20201027120845_fixingorderhasproductconection2")]
    partial class fixingorderhasproductconection2
    {
            ...
            modelBuilder.Entity("BookStore.Models.Orders", b =>
                {
                    ...
                    b.Property<int?>("OrderHasProductOrderId")
                        .HasColumnType("int");

                    b.Property<int?>("OrderHasProductProductId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderHasProductOrderId", "OrderHasProductProductId");
            ...
            modelBuilder.Entity("BookStore.Models.Orders", b =>
                {
                    ...
                    b.HasOne("BookStore.Models.OrderHasProduct", "OrderHasProduct")
                        .WithMany()
                        .HasForeignKey("OrderHasProductOrderId", "OrderHasProductProductId");
                });

            modelBuilder.Entity("BookStore.Models.Product", b =>
                {
                    b.HasOne("BookStore.Models.OrderHasProduct", null)
                        .WithMany("Products")
                        .HasForeignKey("OrderHasProductOrderId", "OrderHasProductProductId");
                });
